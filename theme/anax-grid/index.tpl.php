...
<head>
  ...
  <title><?= isset($title) ? $title . $title_append : ' ' ?></title>
  ...
  <link href='http://fonts.googleapis.com/css?family=Playfair+Display:400,900%7COswald:400,900%7CYesteryear' rel='stylesheet' type='text/css'>
...
<body <?php if(isset($title)) : ?> id='Home' <?php endif; ?>>
<div class="site">
  ...
  <div id='wrapper'>
    ...
    <?php endif; ?>
        ...
        <div id="wrap-main">
          ...
          <?php if ($this->views->hasContent('main-center')) : ?>
            <div id='main-center'><?php $this->views->render('main-center') ?></div>
          <?php endif; ?>
