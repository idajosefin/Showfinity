...
class CommentsController implements \Anax\DI\IInjectionAware
{
    ...
    {   
        ...
        $this->FlashMessages->add('success', 'Comment was posted!');
    ...
    public function saveAction($name = null, $content = null, $email = null, $web = null, $id = null) {
        ...
        $this->FlashMessages->add('success', 'Comment was saved!');
    ...
    public function deleteAction($id = null)
    {
        ...
        $this->FlashMessages->add('success', 'Comment was deleted!');
    ...
    public function deleteAllAction()
    {
        ...
        $this->FlashMessages->add('success', 'All comments deleted!');
