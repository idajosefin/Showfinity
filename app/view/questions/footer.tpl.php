        ...
        <tbody>
            <?php foreach ($questions as $question) : ?>
                <tr>
                    ...
                    <td>
                        <strong><a href="<?=$url?>"><?=(strlen($question->title) > 33) ? substr($question->title,0,30).'...' : $question->title?></a></strong> <span class="right about"><?=$this->time->getRelativeTime($question->created)?></span>
                        <br />
